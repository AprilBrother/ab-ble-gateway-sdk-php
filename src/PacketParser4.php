...
// Parser for Gateway V4
// @link http://wiki.aprbrother.com/wiki/AB_BLE_Gateway_V4
...
class PacketParser4 {
    ...
    const OFFSET_ADV_TYPE       = 0;
    const OFFSET_MAC_ADDRESS    = 1;
    const OFFSET_RSSI           = 7;
    const OFFSET_ADV_DATA       = 8;
    ...
    /**
     * Parse packet from BLE Gateway V4
     * 
     * @link http://wiki.aprbrother.com/wiki/AB_BLE_Gateway_V4
     * @return object BLEAdvData
     */
